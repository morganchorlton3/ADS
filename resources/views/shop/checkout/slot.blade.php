            ...
            <div class="col-lg-6">
                <div class="row">
                    ...
                    <div class="col-lg-3 col">
                        {{checkSlot($slot->id, SlotDate(1)) }}
                    </div>
                    <div class="col-lg-3">
                        {{checkSlot($slot->id, SlotDate(2)) }}
                    </div>
                    <div class="col-lg-3">
                        {{checkSlot($slot->id, SlotDate(3)) }}
                    </div>
                </div>
                </div>
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-3">
                            {{checkSlot($slot->id, SlotDate(4)) }}
                        </div>
                        <div class="col-lg-3">
                            {{checkSlot($slot->id, SlotDate(5)) }}
                        </div>
                        <div class="col-lg-3" >
                            {{checkSlot($slot->id, SlotDate(6)) }}
                        </div>
                        <div class="col-lg-3" >
                            {{checkSlot($slot->id, SlotDate(7)) }}
                        </div>
                    </div>
                </div>
            </div>
